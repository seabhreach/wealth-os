...
and configured rental profit are USC-liable. Cash, taxable-investment, and Amazon asset sales are
excluded.
...
the net spending target; then draws cash, taxable investments, and Amazon shares for any remaining
gap. Any net recurring surplus remains in cash. Rent is recorded by the property stage and is
recognised once by the retirement-funding stage, alongside private and State Pension income;
estimated tax is deducted once.
...
Known limitations include no Irish ETF/fund deemed disposal, CGT on individual shares or
cryptoassets, commodity-disposal taxation, bond-specific taxation, Residential Premises Rental
Income Relief, pension lump-sum tax treatment, or tax on investment disposals. Knowing a holding's
identity and type does not imply tax support. The example baseline disables pension and rental
PRSI; a configured PRSI rate is used only when the matching policy toggle is enabled.
