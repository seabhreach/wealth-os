    ...
    def property_decision(self, *, financing: bool = False) -> LiveWorkspace:
        ...
        evidence = (
            NarrativeEvidence(
                ...
                EvidencePurpose.ANSWER,
                LIVE,
                "Cash is used for the purchase in 2027; configured after-tax rent later supports cash flow and reduces withdrawals from liquid assets. The result depends on the configured rent, growth and tax treatment, and the property remains non-liquid. This is a comparison, not a recommendation.",
                (
            ...
            MetricEvidence(
                ...
                EvidencePurpose.ANSWER,
                LIVE,
                "Additional liquid assets with the property included",
                reconciliation.final_liquid_assets_difference,
                "EUR",
            ),
            ComparisonEvidence(
                "g002-liquidity",
            ...
            AssumptionEvidence(
                "g002-purchase-method",
                "Purchase method",
                EvidencePurpose.ASSUMPTION,
                LIVE,
                "Funding method",
                "Cash purchase",
                "Configured property treatment",
                KNOWN,
            ),
            AssumptionEvidence(
                "g002-rent-growth",
                ...
                "Annual rent growth",
                self._baseline.configuration.assumptions.inflation_rate,
                "Configured inflation-linked rent treatment",
                KNOWN,
            ),
            AssumptionEvidence(
                "g002-appreciation",
